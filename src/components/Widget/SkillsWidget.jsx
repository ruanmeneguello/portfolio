import "./SkillsWidget.css"; // CSS file to format Skills element
import PropTypes from "prop-types";

// SkillsWidget component
        ...
        {skills?.map((skill, index) => (
          <li key={index} data-testid={`skillsWidgetItem${index}`}>
            <div className="skills-item">
              <img data-testid={`skillsWidgetItemLogo${index}`} src={`${skill.icon}`} alt={skill.icon} />
